...
public class TestData {
    ...
    public static String getUserNickName() { return getTestData().userNickName(); }

    public static String getUserPassword() {
        return getTestData().userPassword();
    }

    public static String getUserId() { return getTestData().userId(); }
    ...
    public static String getClientSecret() { return getTestData().clientSecret(); }
